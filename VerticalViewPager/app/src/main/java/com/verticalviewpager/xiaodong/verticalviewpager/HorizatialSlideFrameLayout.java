...
//        setDescendantFocusability(FOCUS_AFTER_DESCENDANTS);
        ...
        mScreenWidth = getHasVirtualKeyWidth(mContext);
        mScreenHeigh = getHasVirtualKeyHeight(mContext);
    ...
    public void startBounceAnim(int startX, int dx, int duration) {
        ...
        Log.e("slidehorizatialqqqq", startX + "______" + dx);
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
                ...
                if (Math.abs(mY) < Math.abs(mX) && Math.abs(mX) > mTouchSlop) {
                    ...
                    if (mDelX > 0) {
                        if (isShow) {
                            ...
                            Log.e("slidehorizatialqqqqisshow", -mDelX + "++++++");
                        }
                    } else {
                        if (!isShow) {
                            ...
                            Log.e("slidehorizatialqqqqnoshow22", -mScreenWidth - mDelX + "++++++");
                        }
                    }
                    return true;
                } else {
            ...
            case MotionEvent.ACTION_CANCEL:
                mCurryX = (int) event.getX();
                mDelX = mCurryX - mLastDownX;
//                Log.e("slidehorizatialqqqqcancel", this.getScrollX() + "___" + mDelX + "____" + mCurryX);
